            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  {format(selectedSlot.start, "hh:mm a")} -{" "}
      ...
      <CardContent className="relative p-0 md:pr-64">
        <div className="p-6">
          <Calendar 
            ...
            modifiersClassNames={{
              available: "bg-blue-50 text-blue-700 font-semibold hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-300"
            }}
          />
        </div>

        <div className="inset-y-0 right-0 flex max-h-80 w-full flex-col border-t p-4 md:absolute md:max-h-none md:w-64 md:border-t-0 md:border-1 md:overflow-y-auto">
          {!date ? (
            ...
            {date && selectedSlot ? (
              <>
                ...
                <span className="font-medium text-slate-900 dark:text-white">
                  {format(selectedSlot.start, "EEE, MMM d")}
                </span>{" "}
                at{" "}
                <span className="font-medium text-slate-900 dark:text-white">
                  {format(selectedSlot.start, "hh:mm a")}
